...
import kemalkeskin.keskinRental.core.utilities.exceptions.ProblemDetails;
import kemalkeskin.keskinRental.core.utilities.exceptions.ValidationProblemDetails;

@SpringBootApplication
@RestControllerAdvice
public class KeskinRentalApplication {

	public static void main(String[] args) {
		SpringApplication.run(KeskinRentalApplication.class, args);
	}
	...
	validationProblemDetails.setMessage("valdiation.exception");
